...
export default class Resources extends EventEmitter {
  constructor() {
    ...
    this.loader.load([
      ...
      { name: "introNexusBase", source: "./models/intro/nexus/base.glb" },
      {
        name: "introNexusCollision",
        source: "./models/intro/nexus/collision.glb",
      },

      { name: "introTedxBase", source: "./models/intro/tedx/base.glb" },
      {
        name: "introTedxCollision",
        source: "./models/intro/tedx/collision.glb",
      },

      // { name: "introBBase", source: "./models/intro/m/base.glb" },
      // { name: "introBCollision", source: "./models/intro/m/collision.glb" },
      ...
      // { name: "introXBase", source: "./models/intro/x/base.glb" },
      // { name: "introXCollision", source: "./models/intro/x/collision.glb" },
...

      {
        ...
        source: "./models/speakers/AanandSrinivas/details.png",
        type: "texture",
      },

      {
        name: "projectsLuniFloor",
        source: "./models/speakers/ChandrikaKambam/details.png",
        type: "texture",
      },
      {
        name: "projectsBonhomme10ansFloor",
        source: "./models/speakers/SanthoshKumarM/details.png",
        type: "texture",
      },
      {
        name: "projectsMadboxFloor",
        source: "./models/speakers/SarvaniYadavalli/details.png",
        type: "texture",
      },
      {
        name: "projectsScoutFloor",
        source: "./models/speakers/VijayPrateik/details.png",
        type: "texture",
      },

      {
        name: "projectsPriorHoldingsFloor",
        source: "./models/speakers/VineetPatawari/details.png",
        type: "texture",
      },
      {
      ...
      {
        name: "sponsors",
        source: "./models/sponsors/sponsors.png",
        type: "texture",
      },
