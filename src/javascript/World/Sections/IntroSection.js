...
export default class IntroSection
{
    ...
    setTitles()
    {
        ...
        this.objects.add({
            base: this.resources.items.introNexusBase.scene,
            collision: this.resources.items.introNexusCollision.scene,
            offset: new THREE.Vector3(0, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
        ...
        this.objects.add({
            base: this.resources.items.introTedxBase.scene,
            collision: this.resources.items.introTedxCollision.scene,
