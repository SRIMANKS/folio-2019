...
export default class Floor {
  constructor(_options) {
   ...
   // Colors
this.colors = {};
this.colors.topLeft = "#E62B1E"; // TEDx red
this.colors.topRight = "#E6453F"; // Slightly lighter red
this.colors.bottomRight = "#E87A6A"; // Light reddish shade
this.colors.bottomLeft = "#E45135"; // Medium reddish tone
